 ...
 * @zh 此文件由脚本 tools/keywords/extract.ts 自动生成。
 * @ja このファイルは tools/keywords/extract.ts スクリプトによって自動生成されます。
 * @see ./tools/keywords/keywords.html
 * @zh ./tools/keywords/keywords.html
 * @ja ./tools/keywords/keywords.html
 * @see tools/keywords/extract.ts
 * @zh tools/keywords/extract.ts
 * @ja tools/keywords/extract.ts
 * @type {string[]}
 * @zh {string[]}
 * @ja {string[]}
 */
