...
class ToshihikoModel extends EventEmitter {
    ...
    beginTransaction(callback) {
        ...
        this.parent.adapter.beginTransaction(callback);
    ...
    commit(conn, callback) {
        ...
        this.parent.adapter.commit(conn, callback);
        return callback.promise;
    }
   ...
   rollback(conn, callback) {
        ...
        this.parent.adapter.rollback(conn, callback);
        return callback.promise;
    }
     ...
     */
    conn(conn) {
        return (new Query(this)).conn(conn);
    }
